...
export default function Settings() {
  const items = [
    ...
    { icon: Bell, title: "Notifikasi", value: "Email, dashboard alert, dan reminder deadline aktif" },
    { icon: Shield, title: "Pengaturan Role", value: "Owner, Kepala Divisi, Staff" },
  ];

  return (
    <Page title="Settings" subtitle="Pengaturan  untuk kebutuhan presentasi prototype.">
