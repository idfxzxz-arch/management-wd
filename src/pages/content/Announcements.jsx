...
export default function Announcements() {
  ...
  return (
    <Page title="Pengumuman Internal" subtitle="Daftar pengumuman perusahaan, target divisi, dan prioritas." action={(user.role === "Owner" || user.role === "Wakil Owner" || user.role === "Developer" || user.role === "HRD") && <button onClick={() => setOpen(true)} className="rounded bg-navy-800 px-4 py-2 text-sm font-semibold text-white">Buat Pengumuman</button>}>
