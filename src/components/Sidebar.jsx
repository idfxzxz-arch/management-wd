...
const menus = [
  ...
  { to: "/hrd", label: "Dashboard HRD", icon: Gauge, roles: ["HRD"] },
  ...
  { to: "/divisions", label: "Divisi", icon: Building2, roles: ["Owner", "Kepala Divisi", "Staff", "Magang", "Wakil Owner", "Developer", "HRD"] },
  ...
  { to: "/reports", label: "Laporan Kerja", icon: FileText, roles: ["Owner", "Kepala Divisi", "Staff", "Magang", "Wakil Owner", "Developer", "HRD"] },
  { to: "/announcements", label: "Pengumuman", icon: Bell, roles: ["Owner", "Kepala Divisi", "Staff", "Magang", "Wakil Owner", "Developer", "HRD"] },
  { to: "/sop", label: "SOP", icon: ClipboardList, roles: ["Owner", "Kepala Divisi", "Staff", "Magang", "Wakil Owner", "Developer"] },
  { to: "/documents", label: "Arsip Dokumen", icon: Archive, roles: ["Owner", "Kepala Divisi", "Staff", "Magang", "Wakil Owner", "Developer", "HRD"] },
  { to: "/activity-log", label: "Activity Log", icon: Activity, roles: ["Owner", "Kepala Divisi", "Staff", "Magang", "Wakil Owner", "Developer", "HRD"] },
  { to: "/users", label: "User Management", icon: UserCog, roles: ["Owner", "Kepala Divisi", "Staff", "Magang", "Wakil Owner", "Developer", "HRD"] },
  { to: "/profile", label: "Profile", icon: UserCircle, roles: ["Owner", "Kepala Divisi", "Staff", "Magang", "Wakil Owner", "Developer", "HRD"] },
